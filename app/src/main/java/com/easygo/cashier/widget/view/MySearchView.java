...
//        mEditText.setInputType(InputType.TYPE_CLASS_NUMBER | InputType.TYPE_NUMBER_VARIATION_NORMAL);
    ...
    private void initView(Context context) {
        ...
        mEditText = mView.findViewById(R.id.et_search);
        mSearchBtn = mView.findViewById(R.id.btn_search);
        mClear = mView.findViewById(R.id.cl_clear);
        mLoading = mView.findViewById(R.id.cl_loading);
    }
    ...
    private void initAttr(Context context, AttributeSet attrs) {
        ...
        if (ta != null) {
            ...
            mSearchBtnTextSize = ta.getDimensionPixelSize(R.styleable.MySearchView_search_btn_text_size, -1);

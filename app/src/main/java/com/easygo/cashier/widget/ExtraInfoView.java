...
public class ExtraInfoView extends ConstraintLayout {
    ...
    private void initView(Context context) {
        ...
        clMember = (ConstraintLayout) mView.findViewById(R.id.cl_member);
        clCoupon = (ConstraintLayout) mView.findViewById(R.id.cl_coupon);
        clGiftCard = (ConstraintLayout) mView.findViewById(R.id.cl_gift_card);
        ivCancelMember = (ImageView) mView.findViewById(R.id.iv_cancel_member);
        ivCancelCoupon = (ImageView) mView.findViewById(R.id.iv_cancel_coupon);
        ivCancelGiftCard = (ImageView) mView.findViewById(R.id.iv_cancel_gift_card);

        tvMember = (TextView) mView.findViewById(R.id.tv_member);
        tvBalance = (TextView) mView.findViewById(R.id.tv_balance);
        tvIntegral = (TextView) mView.findViewById(R.id.tv_integral);

        tvCouponNo = (TextView) mView.findViewById(R.id.tv_coupon_no);
        tvCouponPrice = (TextView) mView.findViewById(R.id.tv_coupon_price);

        tvGiftCardNo = (TextView) mView.findViewById(R.id.tv_gift_card_no);
        tvGiftCardPrice = (TextView) mView.findViewById(R.id.tv_gift_card_price);
